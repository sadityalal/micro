...
-- Settings Indexes
CREATE INDEX idx_settings_tenant_id ON frontend_settings(tenant_id);
CREATE INDEX idx_tax_rates_country ON country_tax_rates(country_code);
CREATE INDEX idx_state_tax_rates_state ON state_tax_rates(state_code);
...
INSERT INTO security_settings (tenant_id, password_min_length, password_require_uppercase, password_require_lowercase, password_require_numbers, password_require_symbols, max_login_attempts, lockout_duration_minutes, jwt_secret) VALUES
(1, 8, true, true, true, true, 5, 30, 'your-super-secure-jwt-secret-key-change-in-production');

-- Insert Site Settings (Service URLs)
